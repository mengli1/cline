	...
	return (
		<div>
			...
			{showModelOptions && (
				<>
					<ModelSelector
						label={t("api_provider.nousresearch.model_label")}
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>{t("api_provider.nousresearch.note_text")}:</span>{" "}
							{t("api_provider.nousresearch.note_content")})
						</span>
					</p>
				</>
			)}
